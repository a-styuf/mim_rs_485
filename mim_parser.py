...
from bytes_parser.frame_struct import Frame, SubFrame, Row, BitFlag
...
mim_err = [
    Row('MIM_STATUS', 2, 'X',
        bit_fields=[BitFlag(0, 'WORKING', True),
                    BitFlag(1, 'S_TX', False),
                    BitFlag(2, 'EXP_MODE', False),
                    BitFlag(8, 'RX_BUF_NOT_EMPTY', False),
                    BitFlag(9, 'TX_BUF_NOT_EMPTY', False)],
        min_value=1, max_value=1),
    Row('ERR_STATUS', 2, 'X',
        bit_fields=[BitFlag(0, 'PWR_ERR', False),
                    BitFlag(1, 'INTERFACE_1_ERR', False),
                    BitFlag(2, 'INTERFACE_2_ERR', False),
                    BitFlag(3, 'INTERNAL_BUS_ERR', False),
                    BitFlag(4, 'RX_OVERFLOW_ERR', False),
                    BitFlag(5, 'TX_OVERFLOW_ERR', False),
                    BitFlag(6, 'SINGLE_CMD_ERR', False),
                    BitFlag(7, 'EXP_PARAM_ERR', False)]),
]
...
ID1: Frame = Frame('ID1', [
    ...
    *SubFrame(mim_err),
    ...
    Row('PWR_STATUS', 2, 'X', max_value=0,
        bit_fields=[BitFlag(0, 'INTERFACE', False),
                    *[BitFlag(i, f'RADIO_{i}', False) for i in range(1, 14)]]),
...
system_data_1: list[Row] = [x for i in range(6) for x in [
    ...
    Row(f'STATUS_{i + 1}', 2, 'X',
        bit_fields=[BitFlag(0, 'WORKING', True),
                    BitFlag(1, 'INTERNAL_BUS_ERR', False),
                    BitFlag(2, 'RX_BUF_NOT_EMPTY', False),
                    BitFlag(3, 'TX_BUF_NOT_EMPTY', False),
                    BitFlag(4, 'VOLTAGE_ERR', False),
                    BitFlag(5, 'PWR_ERR', False),
                    BitFlag(6, 'MOSFET_ERR', False),
                    BitFlag(7, 'UNKNOW_PWR_ERR', False),
                    BitFlag(8, 'TX_1_ERR', False),
                    BitFlag(9, 'TX_2_ERR', False),
                    BitFlag(10, 'TX_3_ERR', False),
                    BitFlag(11, 'TX_4_ERR', False),
                    BitFlag(12, 'RX_BUF_OVERFLOW', False),
                    BitFlag(13, 'TX_BUF_OVERFLOW', False),
                    BitFlag(15, 'UNKNOWN_ERR', False)]),
...
exp_report_body: list = [
    ...
    Row('STATUS', 1, 'X',
        bit_fields=[BitFlag(0, 'WORKING', True),
                    BitFlag(1, 'ERROR', False),
                    BitFlag(2, 'EMPTY_TX_BUF', False),
                    BitFlag(3, 'RX_ERR', False),
                    BitFlag(4, 'RUN_ERR', False),
                    BitFlag(5, 'RX_BUF_OVERFLOW', False),
                    BitFlag(6, 'SAVE_BUF_OVERFLOW', False)]),
    Row('ERROR_CNT', 2),
    Row('STEP_NUM', 2),
    Row('STEP_NUM_MAX', 2),
    Row('PERIOD_S', 2),
